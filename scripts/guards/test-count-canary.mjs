 ...
 */
/*
 * Close-out H3 / P0.5 (8 September 2026), one file and seven tests:
 * tests/unit/ci/gate-client-sdk-parity (six: the local gate can never again
 ...
 * 328 files / 3744, as the canary measured.
 */
const MIN_FILES = 328
const MIN_TESTS = 3744
