...
const routes = [
  ...
  ['culture-pacific',            '/culture/pacific'],
  ['cultures-index',             '/cultures'],
  // Intersections
  ['culture-african-sydney',     '/culture/african/sydney'],
  ['culture-south-asian-melb',   '/culture/south-asian/melbourne'],
  ['culture-caribbean-melb',     '/culture/caribbean/melbourne'],
  ['culture-pacific-sydney',     '/culture/pacific/sydney'],
  ['culture-latin-sydney',       '/culture/latin/sydney'],
  // Cities
