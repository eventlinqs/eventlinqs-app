// Run mobile Lighthouse against the Pre-Task 3 preview deployment for
// every URL in the lighthouserc.json gate. Saves JSON + HTML reports
// per route into docs/sprint1/phase-1b/iter-7-production-real-device/.
import { execSync } from 'node:child_process'

const PREVIEW = 'https://eventlinqs-n6t55uag6-lawals-projects-c20c0be8.vercel.app'
