import { CalendarClock, Clock, Lock, Wallet, Banknote } from 'lucide-react'
  ...
  const cards = [
    {
      key: 'available',
      label: 'Available now',
      value: formatCents(summary.availableCents, summary.currency),
      hint: 'Claimable balance, net of holds',
      icon: Banknote,
      tone: 'gold' as const,
    },
    {
...
function toneClasses(tone: 'warning' | 'success' | 'neutral' | 'gold'): string {
  switch (tone) {
    case 'warning':
