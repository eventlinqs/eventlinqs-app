...
export function OrganisersLandingPage() {
  return (
    <PageShell>
      ...
      <ContentSection surface="alt" width="default" reveal>
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-[var(--text-secondary)]">
            ...
            Weddings, birthday parties, community festivals, concerts, corporate events,
          ...
          <ul className="mt-6 space-y-2">
            {[
              ...
              'Owambe celebrations and community ceremonies',
      ...
      {/* -- 6. Final CTA band (light canvas, navy-on-canvas) -------- */}
