...
/**
 * CommunityPicksRail - tabbed horizontal rails for the Community Picks section.
 *
...
export interface CommunityPicksTab {
  slug: string
  label: string
  href: string
  cards: ReactNode
...
interface Props {
  tabs: CommunityPicksTab[]
}

export function CommunityPicksRail({ tabs }: Props) {
