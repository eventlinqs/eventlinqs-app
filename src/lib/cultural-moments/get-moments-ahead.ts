import { CULTURAL_MOMENTS, type CulturalMoment } from './calendar'

/**
 * Returns the next `count` cultural moments whose end-date is on or after
 ...
 */
export function getMomentsAhead(count = 4, now: Date = new Date()): CulturalMoment[] {
 ...
 */
export function formatMomentDates(m: CulturalMoment): string {
