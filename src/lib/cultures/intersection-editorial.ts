...
const INTERSECTIONS: Record<string, IntersectionEntry> = {
  ...
  'african/canberra': {
    ...
    editorial:
      "Canberra's African community is education-led and embassy-anchored. African Australian students at ANU and University of Canberra run cultural societies that organise everything from Afrobeats nights at Mooseheads to Independence Day galas at the National Convention Centre. The South Sudanese community in Tuggeranong and Wanniassa is the most established, with weekend cultural nights at the Tuggeranong Community Hub. Ethiopian and Eritrean families gather around Belconnen, Nigerian Owambe celebrations rotate through Civic and Belconnen halls, and the African Communities Council Canberra coordinates the city's annual African Festival at Garema Place. Embassy receptions for African nations fill the calendar with diplomatic culture nights too. EventLinqs is built for Canberra African organisers running events that punch well above the city's size and weight.",
  },
  'african/hobart': {
    hero_subtitle: "Apple Isle, African heart.",
    editorial:
      "Hobart's African community is small and proud. The Tasmanian African Communities Council brings together Sudanese, Eritrean, Liberian, Sierra Leonean and Burundian families who came through the humanitarian intake settled in Glenorchy and Bridgewater. Annual African Day celebrations at the Hobart Town Hall pull every community together for one big shared meal and a long evening of music from across the continent. Sudanese weddings at the Bellerive Yacht Club, Ethiopian coffee ceremonies through North Hobart cafes, the Multicultural Council of Tasmania running quarterly cultural nights at PCYC Glenorchy. The community is small enough that everyone is on the same WhatsApp groups, and welcomes new arrivals with proper old-country hospitality. EventLinqs is built for Hobart African organisers keeping the continental rhythm alive in Australia's southernmost capital.",
  },
  'african/newcastle': {
  ...
  'caribbean/canberra': {
    ...
    editorial:
      "Canberra's Caribbean community is small and embassy-flavoured. The Jamaica High Commission anchors a quietly steady calendar of cultural events through the year, and the wider Caribbean Australia network coordinates Carnival weekends that pull everyone to Sydney each February. Reggae nights at Mooseheads, dancehall at the Phoenix Pub, Trinidadian J'ouvert breakfasts at Lake Burley Griffin when the weather plays nice. ANU Caribbean Society pulls a steady stream of student-led cultural nights through every semester. Jamaican rum at Smith's Alternative, Bajan BBQs at Black Mountain Peninsula, Caribbean Gospel through churches in Tuggeranong. EventLinqs is built for Canberra Caribbean organisers running events that hold a tight community in the federal capital.",
  },
  'caribbean/hobart': {
    hero_subtitle: "Apple Isle, island warmth.",
    editorial:
      "Hobart's Caribbean community is tiny and proud. Reggae sundowners at the Republic Bar, dancehall nights at Brisbane Hotel, Trinidadian J'ouvert breakfasts at Hobart's waterfront when summer comes through. The wider Caribbean Australia WhatsApp groups keep Hobart connected to Sydney, Melbourne and Brisbane, and the annual Caribbean Festival in Sydney pulls a Hobart crew across each February. Jamaican rum at Lark Distillery's tasting room, Bajan beach lunches at Sandy Bay, Caribbean Gospel through churches in Glenorchy. The University of Tasmania Caribbean Students Society runs cultural nights each semester. The community is small enough that one warm WhatsApp can fill a room. EventLinqs is built for Hobart Caribbean organisers keeping island rhythm alive in Australia's coldest capital.",
  },
  'caribbean/newcastle': {
  ...
  'latin/canberra': {
    ...
    editorial:
      "Canberra's Latin community is embassy and university-anchored. The Argentine, Chilean, Mexican, Brazilian and Colombian embassies run year-round cultural events that feed into community calendars. Salsa Saturdays at the Hellenic Club in Woden run weekly, bachata socials at Mooseheads pull three hundred, reggaeton at the Phoenix Pub packs Civic. Latin Festival every March at Glebe Park brings everyone together for one big day of Pan-American food, music and dance. Cuban son nights at Smith's Alternative, Argentine tango milongas at the Italo-Australian Club, Mexican Day of the Dead at Commonwealth Park. The ANU Latin American Students Society and the Embassy of Brazil pull a steady stream of cultural events through every semester. EventLinqs is built for Canberra Latin organisers running events that punch above the federal capital's size and weight.",
  },
  'latin/hobart': {
  ...
  'east-asian/canberra': {
    ...
    editorial:
      "Canberra's East Asian community is education and embassy-anchored. The Chinese, Korean, Japanese, Vietnamese and Thai embassies run year-round cultural events that feed into community calendars. Belconnen and Gungahlin hold the Chinese families, Tuggeranong holds the Vietnamese community, Dickson is Canberra's Asian food heart. Lunar New Year at the National Convention Centre, K-pop fan meets at the AIS Arena, Korean Festival every September at Glebe Park, Vietnamese Tet at the Tuggeranong Community Hub, Japanese matsuri at Lennox Gardens. The ANU Asia-Pacific Studies Program runs a tight cultural calendar through every semester, and the National Multicultural Festival every February brings everyone together. EventLinqs is built for Canberra East Asian organisers running events that punch well above the federal capital's size and weight.",
  },
  'east-asian/hobart': {
  ...
  'middle-eastern/toronto': {
    ...
    editorial:
      "Toronto's Middle Eastern community is the largest in Canada. North York holds the Persian families (the largest Iranian community in Canada), Mississauga holds the Lebanese and Egyptian families, Scarborough holds the Iraqi and Syrian community, the Annex holds the Turkish families. Tirgan Festival every July at Harbourfront Centre pulls fifty thousand for the largest Persian cultural festival outside Iran, Lebanese Festival at the Distillery District every August, Turkish Festival at Mel Lastman Square every July, Iraqi Cultural Festival every October at the Civic Centre. Persian food on Yonge Street north, Lebanese food on Eglinton Avenue. The Iranian Canadian Congress and Canadian Lebanese Cultural Foundation coordinate the year-round calendar. EventLinqs is built for Toronto Middle Eastern organisers running events that anchor Canada's biggest Levantine community.",
  },
  'middle-eastern/dubai': {
    hero_subtitle: "Where the Middle East meets the world.",
    editorial:
      "Dubai is the cultural crossroads of the modern Middle East. Old Dubai's Bur Dubai holds the heritage Persian and Arab merchant families, Deira holds the historic Lebanese and Syrian community, Jumeirah holds the wealthy Persian-Emirati families, Bur Saeed holds the Egyptian community. Norouz at Atlantis the Palm every March pulls forty thousand, Eid at the Dubai Mall pulls a million, Sheikh Zayed Festival at Al Wathba every November runs three months of Levantine celebration. Lebanese food on Sheikh Zayed Road, Persian food in Bur Dubai, Turkish food in Jumeirah. The Dubai Cultural Council coordinates year-round events. EventLinqs is built for Dubai Middle Eastern organisers running events that anchor the cultural and commercial heart of the modern Levant.",
  },
  'middle-eastern/beirut': {
    hero_subtitle: "Where the music begins.",
    editorial:
      "Beirut is the cultural capital of the Middle East. Hamra holds the historic Lebanese arts scene, Achrafieh holds the Christian-Maronite culture, Mar Mikhael holds the contemporary live music venues, Verdun holds the high-end concert halls. Beirut International Film Festival every October, Beiteddine Festival in summer pulling fifty thousand for Arab classical and contemporary music, Byblos International Festival every July at the ancient port. Lebanese food across every quarter, the global Levantine sound exported from Beirut clubs to every corner of the world. The geography puts Beirut at the centre of every major Levantine cultural calendar, and the city moves at the rhythm of the entire Middle East. EventLinqs is built for Beirut Middle Eastern organisers running events that the global Levant watches and copies.",
  },
