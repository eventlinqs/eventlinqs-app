...
const SUBURB_QUERIES: Record<string, string> = {
  'sydney-inner-west':         'newtown sydney street art cafe community people',
  'sydney-north-shore':        'north sydney harbour bridge skyline elegant',
  'sydney-eastern-suburbs':    'bondi beach sydney sunset surfers',
  'sydney-western-sydney':     'parramatta sydney diverse multicommunity community',
  'sydney-northern-beaches':   'manly beach sydney boardwalk lifestyle',
  'sydney-sutherland-shire':   'cronulla beach sydney wave surfers',
  'melbourne-inner-melbourne': 'melbourne laneway street art cafe community',
  'melbourne-eastern-suburbs': 'melbourne suburbs leafy residential lifestyle',
  'melbourne-western-suburbs': 'footscray melbourne diverse multicommunity',
  'melbourne-northern-suburbs':'brunswick melbourne street community creative',
  ...
  'brisbane-west-end':         'fortitude valley brisbane street community nightlife',
  'perth-inner-perth':         'perth city kings park people lifestyle',
  'perth-northern-suburbs':    'perth coastal beach scarborough sunset',
  'perth-southern-suburbs':    'fremantle perth markets street community people',
