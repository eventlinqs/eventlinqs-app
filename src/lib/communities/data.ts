/**
 * Community content registry - the single source of truth for the
 * Community Taxonomy v2 heritage landing pages at /community/[slug].
 *
 * v2 (founder decisions A-G, locked 2026-05-16): 21 community heritages,
 ...
 *
 * The `CommunityContent` interface and the getCommunity / getAllCommunities /
 * isCommunitySlug / COMMUNITY_SLUGS API are intentionally unchanged from v1
 ...
 * /communities index renders one ordered list with First Nations pinned
...
export interface CommunityContent {
  ...
  /** Sub-communities rail: in-heritage breakdown / sub-filter tabs. */
  subCommunities: SubCommunity[]
  /** Cities where this community has critical mass. */
  cities: string[]
  /** Cross-discovery rail. */
  relatedCommunities: CommunitySlug[]
...
const COMMUNITIES: Record<CommunitySlug, CommunityContent> = {
  'aboriginal-torres-strait-islander': {
    ...
    cities: AU_CORE,
    relatedCommunities: ['pacific-pasifika', 'maori', 'african'],
    relatedFaiths: [],
    organiserPersonas: [
  ...
  african: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['caribbean', 'arab', 'latin-american'],
  ...
  caribbean: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['african', 'latin-american', 'arab'],
    relatedFaiths: ['christian'],
    organiserPersonas: [
  ...
  indian: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['other-south-asian', 'persian-iranian', 'arab'],
    relatedFaiths: ['hindu'],
    organiserPersonas: [
  ...
  chinese: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['vietnamese', 'korean', 'other-east-southeast-asian'],
  ...
  filipino: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['pacific-pasifika', 'other-east-southeast-asian', 'chinese'],
    relatedFaiths: ['christian'],
    organiserPersonas: [
  ...
  'latin-american': {
    ...
    cities: AU_CORE,
    relatedCommunities: ['caribbean', 'african', 'italian'],
    relatedFaiths: ['christian'],
    organiserPersonas: [
  ...
  vietnamese: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['chinese', 'other-east-southeast-asian', 'filipino'],
    relatedFaiths: ['buddhist'],
    organiserPersonas: [
  ...
  'lebanese-levantine': {
    ...
    cities: AU_CORE,
    relatedCommunities: ['arab', 'turkish', 'persian-iranian'],
  ...
  greek: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['italian', 'other-european', 'turkish'],
    relatedFaiths: ['christian'],
    organiserPersonas: [
  ...
  italian: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['greek', 'other-european', 'latin-american'],
    relatedFaiths: ['christian'],
    organiserPersonas: [
  ...
  korean: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['japanese', 'chinese', 'other-east-southeast-asian'],
  ...
  japanese: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['korean', 'chinese', 'other-east-southeast-asian'],
    relatedFaiths: ['buddhist'],
    organiserPersonas: [
  ...
  'pacific-pasifika': {
    ...
    cities: AU_CORE,
    relatedCommunities: ['maori', 'aboriginal-torres-strait-islander', 'filipino'],
    relatedFaiths: ['christian'],
    organiserPersonas: [
  ...
  maori: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['pacific-pasifika', 'aboriginal-torres-strait-islander', 'filipino'],
    relatedFaiths: ['christian'],
    organiserPersonas: [
  ...
  'persian-iranian': {
    ...
    cities: AU_CORE,
    relatedCommunities: ['arab', 'lebanese-levantine', 'turkish'],
    relatedFaiths: [],
    organiserPersonas: [
  ...
  turkish: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['lebanese-levantine', 'arab', 'persian-iranian'],
  ...
  arab: {
    ...
    cities: AU_CORE,
    relatedCommunities: ['lebanese-levantine', 'persian-iranian', 'turkish'],
    relatedFaiths: ['muslim', 'christian'],
    organiserPersonas: [
  ...
  'other-south-asian': {
    ...
    cities: AU_CORE,
    relatedCommunities: ['indian', 'arab', 'other-east-southeast-asian'],
  ...
  'other-east-southeast-asian': {
    ...
    cities: AU_CORE,
    relatedCommunities: ['vietnamese', 'chinese', 'filipino'],
    relatedFaiths: ['buddhist'],
    organiserPersonas: [
  ...
  'other-european': {
    ...
    cities: AU_CORE,
    relatedCommunities: ['italian', 'greek', 'latin-american'],
    relatedFaiths: ['christian'],
    organiserPersonas: [
...
/**
 * Batch 11.0 AU-first launch lock: filter community.cities to AU
 * display-names only before exposing to consumers. The raw COMMUNITIES
...
function filterToAuCities(community: CommunityContent): CommunityContent {
  const auCities = community.cities.filter(c => AU_CITY_DISPLAY_NAMES.has(c))
  if (auCities.length === community.cities.length) return community
  return { ...community, cities: auCities }
}

/** Heritage-order sort, First Nations always first. */
function byHeritageOrder(a: CommunityContent, b: CommunityContent): number {
  return a.heritageOrder - b.heritageOrder
}

export function getCommunity(slug: string): CommunityContent | null {
  const c = COMMUNITIES[slug as CommunitySlug]
  return c ? filterToAuCities(c) : null
}

export function isCommunitySlug(slug: string): slug is CommunitySlug {
  return slug in COMMUNITIES
}

export function getAllCommunities(): CommunityContent[] {
  return Object.values(COMMUNITIES).map(filterToAuCities).sort(byHeritageOrder)
}

/**
 * v2: tier is retained for interface stability only. Every heritage is
 * tier 1, so getTier1Communities returns the full ordered list and
 * getTier2Communities returns an empty array. The /communities index renders
 * one ordered list and pins First Nations first via heritageOrder.
 */
export function getTier1Communities(): CommunityContent[] {
  return getAllCommunities()
}

export function getTier2Communities(): CommunityContent[] {
  return []
}

export const COMMUNITY_SLUGS: CommunitySlug[] = (Object.values(COMMUNITIES) as CommunityContent[])
