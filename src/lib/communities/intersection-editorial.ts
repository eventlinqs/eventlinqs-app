/**
 * Hand-crafted editorial copy for every /community/[community]/[city]
 * intersection page (Batch 8). 271 unique entries, each with a
 * community-specific hero subtitle and a 150-250 word editorial
 * paragraph.
 *
 ...
 *   - 3+ named community sub-communities or sub-communities
 *   - 2+ named event types popular in that combination
 *   - 1+ specific community reference insiders will recognise
 *   - Closing organiser-pride line specific to the community in that city
 *
 * The map is partitioned by community for readability. Entries are
 * keyed `${communitySlug}/${citySlug}` where citySlug is the lowercase-
...
const INTERSECTIONS: Record<string, IntersectionEntry> = {
  ...
  'african/perth': {
    ...
    editorial:
      "Perth's African community is small, scattered, and tight. Mirrabooka is the centre - Sudanese, Eritrean, Ethiopian, Liberian, Sierra Leonean families running community events through the Multicommunity Services Centre and out into Balga, Girrawheen, Beechboro. South African braais run weekly through Joondalup and Hillarys. Nigerian Independence Day at the Perth Convention Centre. Zimbabwean Heritage Day at Stirling Civic Gardens. Amapiano nights have found Northbridge and the Old Shanghai precinct, and West African drum circles meet at Hyde Park. The Perth African scene punches above its size because everyone knows everyone, and a single WhatsApp group can fill a hall in 24 hours. EventLinqs is built for Perth African organisers running events that hold a community together across the country's most isolated capital.",
  },
  'african/adelaide': {
  ...
  'caribbean/perth': {
    ...
    editorial:
      "Perth's Caribbean community is the smallest in any Australian capital, and the most resilient. Carnival rehearsals at the Multicommunity Services Centre in Mirrabooka build through autumn for the Perth Caribbean Carnival every March. Reggae nights at the Indi Bar and the Bird, dancehall warehouse parties through Northbridge, Trinidadian J'ouvert breakfasts at Cottesloe Beach when the dawn comes warm. The wider Caribbean Australia network keeps the Perth crew connected to Sydney and Melbourne, and twice a year the Sydney mas band crosses the country. Jamaican rum bars in Fremantle, Bajan beach BBQs at Scarborough, Caribbean Gospel through community churches in Gosnells. EventLinqs is built for Perth Caribbean organisers running events that hold a tiny tight community across Australia's most isolated city.",
  },
  'caribbean/adelaide': {
  ...
  'latin/madrid': {
    ...
    editorial:
      "Madrid is where Spain and Latin America meet. Lavapies and Embajadores hold the Latin American immigrant communities, with Bolivian, Ecuadorian, Peruvian, Colombian and Dominican families running community events through community halls and Spanish parish centres. Salsa Saturdays at the Cocoroco run weekly, bachata at the Florida Park packs Madrid every Friday, reggaeton at the Cool fills Gran Via weekends. Carnaval de Las Americas every July at Casa de America brings Pan-American rhythm to the heart of the city. Cuban son nights at the Cafe Central, Argentine tango milongas at the Cafe Berlin, Mexican Day of the Dead at the Centro Community Conde Duque. The community is the biggest Latin presence in Europe outside London, and the language ties run deep. EventLinqs is built for Madrid Latin organisers running events that anchor Pan-American community in the Spanish-speaking heart of Europe.",
  },
  ...
  'filipino/geelong': {
    ...
    editorial:
      "Geelong's Filipino community has grown rapidly through professional migration into the Western District. Norlane and Corio hold the Filipino-Australian families, Highton holds the older Manila professional class, Belmont holds the new Cebuano and Visayan arrivals. Sinulog parade every January through central Geelong pulls six hundred, Sunday Tagalog Mass at St Mary's in Geelong, Independence Day at Johnstone Park every June, parol-lit Christmas at the Wool Exchange, OPM concerts at GMHBA Stadium function rooms. The Geelong Filipino-Australian Community Society coordinates the year-round calendar. Filipino basketball tournaments at the Geelong Arena double as community gatherings. Deakin University Filipino Students Society pulls fresh student energy each semester. EventLinqs is built for Geelong Filipino organisers running events that bring homeland warmth to the second city of Victoria.",
  },
  ...
  'mediterranean/sunshine-coast': {
    ...
    editorial:
      "The Sunshine Coast Mediterranean community is mid-sized and lifestyle-led. Buderim and Mountain Creek hold the Italian families, Maroochydore holds the Greek community, Caloundra holds the Lebanese families, Mooloolaba holds the Spanish community. Italian Festa every October at Cotton Tree Park pulls three thousand, Glendi Greek Festival every May at Mooloolaba Esplanade pulls two thousand, Spanish Community Festival every November at the Lake Kawana Community Centre, Lebanese Mahrajan every June at the Maroochy RSL function rooms. Italian food on Mooloolaba Esplanade and Hastings Street Noosa, Greek food in Caloundra. The Sunshine Coast Italian Australian Community Society and Hellenic Community of the Sunshine Coast coordinate the year-round calendar. EventLinqs is built for Sunshine Coast Mediterranean organisers running events that match coast lifestyle to old-country warmth.",
  },
  'mediterranean/cairns': {
    hero_subtitle: "Tropical north, Mediterranean sun.",
    editorial:
      "Cairns has a small but proud Mediterranean community. Manunda holds the Italian families, Earlville holds the Greek community, Westcourt holds the Lebanese and Spanish families. Italian Community Day every October at Munro Martin Parklands pulls one thousand, Greek Community Festival every May at the Cairns Showgrounds, Spanish Community Festival every November at the Cairns Convention Centre, Lebanese Mahrajan every June at the Brothers Leagues Club. Italian food on Sheridan Street, Greek food in Edge Hill. The Far North Queensland Italian Australian Community Society and Hellenic Community of Cairns coordinate the year-round calendar. The James Cook University Mediterranean Studies programme runs community nights through every semester. EventLinqs is built for Cairns Mediterranean organisers running events that bring old-country celebration into the tropics.",
  },
  'mediterranean/darwin': {
    hero_subtitle: "Top End energy, Mediterranean warmth.",
    editorial:
      "Darwin's Mediterranean community is small, dry-season-anchored, and outdoor-led. Karama holds the Italian families, Anula holds the Greek community, Casuarina holds the Lebanese and Spanish families. Italian Community Day every August at Bicentennial Park pulls one thousand, Glenti Greek Festival every June at the Greek Hall in Stuart Park pulls eight hundred, Spanish Community Festival every September at the Darwin Convention Centre, Lebanese Mahrajan every June at the Greek Hall. Italian food on Mitchell Street, Greek food on Knuckey Street. The Northern Territory Italian Community Society and Hellenic Community of the NT coordinate the year-round calendar. The Charles Darwin University Mediterranean Studies programme runs community nights through every semester. EventLinqs is built for Darwin Mediterranean organisers running events that bring old-country warmth to Australia's most tropical capital.",
  },
  'mediterranean/townsville': {
    hero_subtitle: "Tropical north, Mediterranean rhythm.",
    editorial:
      "Townsville's Mediterranean community is mid-sized and family-led. Annandale holds the Italian families, Kelso holds the Greek community, Kirwan holds the Lebanese and Spanish families. Italian Community Day every October at Riverway pulls one thousand, Glendi Greek Festival every May at the Townsville Greek Hall pulls eight hundred, Spanish Community Festival every November at the Civic Theatre, Lebanese Mahrajan every June at the Brothers Leagues Club. Italian food on Flinders Street, Greek food in Aitkenvale. The North Queensland Italian Australian Community Society and Hellenic Community of Townsville coordinate the year-round calendar. The James Cook University Mediterranean Studies programme runs community nights through every semester. EventLinqs is built for Townsville Mediterranean organisers running events that anchor old-country celebration in tropical north Queensland.",
  },
  'mediterranean/london': {
    hero_subtitle: "Soho and beyond, Mediterranean Europe.",
    editorial:
      "London's Mediterranean community is the most diverse in Europe. Soho's Italian Quarter is the historic heart, Wood Green holds the Greek Cypriot community (the largest outside Cyprus), Edgware Road holds the Lebanese families, Notting Hill and Soho hold the Spanish community. Italian Festa at St Peter's Italian Church in Clerkenwell every July pulls three thousand, Greek Cypriot Wine Festival in Alexandra Park every August pulls fifteen thousand, Spanish Community Festival at Trafalgar Square every September, Lebanese Festival every July at the Royal Festival Hall. Italian food in Soho's Frith Street, Greek food in Wood Green's Green Lanes, Lebanese food on Edgware Road. The Italian Community Institute and Hellenic Centre coordinate the year-round calendar. EventLinqs is built for London Mediterranean organisers running events that anchor the most diverse European-Mediterranean community in the world.",
  },
  ...
  'mediterranean/toronto': {
    ...
    editorial:
      "Toronto's Mediterranean community runs through Little Italy and Greektown. College Street is Little Italy, Danforth Avenue is Greektown, Woodbridge holds the Italian-Canadian suburban community (the largest outside Italy), Mount Pleasant holds the Lebanese families. Italian Festa at the Cultura Italiana di Toronto every June pulls eight thousand, Krinos Taste of the Danforth every August pulls a million for the largest Greek festival outside Greece, Spanish Community Festival at Yonge-Dundas Square every November, Lebanese Festival at the Civic Centre every July. Italian food on College Street, Greek food on Danforth Avenue. The Italian Community Institute and Hellenic Heritage Foundation coordinate the year-round calendar. EventLinqs is built for Toronto Mediterranean organisers running events that anchor the largest Italian and Greek communities outside their home countries.",
  },
  'mediterranean/rome': {
  ...
  'middle-eastern/melbourne': {
    ...
    editorial:
      "Melbourne's Middle Eastern community runs through the north and west. Coburg holds the Lebanese families, Brunswick holds the Turkish community, Broadmeadows and Dallas hold the Iraqi and Syrian families, Glen Waverley holds the Iranian and Persian community. Lebanese Mahrajan at Royal Park every May pulls twenty thousand, Persian Norouz at Federation Square every March pulls ten thousand, Turkish Community Festival at Sydney Road every August, Iraqi Community Festival at the Coburg Town Hall every October. Lebanese food on Sydney Road and Dynon Road, Persian food on High Street Northcote, Turkish food on Sydney Road. Brunswick's Sydney Road carries one of the densest Middle Eastern food strips in Australia. The Lebanese Muslim Association of Australia and the Iranian Community Society of Victoria coordinate year-round events. EventLinqs is built for Melbourne Middle Eastern organisers running events that have shaped the city's most distinctive northern food and festival communities.",
  },
  'middle-eastern/brisbane': {
    hero_subtitle: "Sunshine state, Middle Eastern hospitality.",
    editorial:
      "Brisbane's Middle Eastern community is mid-sized and growing. Sunnybank Hills holds the Lebanese families, Mt Gravatt holds the Persian community, Inala holds the Iraqi and Syrian families, Springwood holds the Turkish community. Lebanese Mahrajan in Brisbane every May at Roma Street Parkland pulls eight thousand, Persian Norouz at the Brisbane Convention Centre every March pulls four thousand, Turkish Community Festival at South Bank every August, Iraqi Community Festival at the Inala Civic Centre every October. Lebanese food on Beaudesert Road and Greenslopes Mall, Persian food in Sunnybank Hills, Turkish food on Logan Road. The Lebanese Australian Community Society of Queensland and Iranian Community Society of Queensland coordinate year-round events. EventLinqs is built for Brisbane Middle Eastern organisers running events that anchor a fast-growing community across Queensland's southside.",
  },
  'middle-eastern/perth': {
    hero_subtitle: "Indian Ocean to Levantine warmth.",
    editorial:
      "Perth's Middle Eastern community is established and family-led. Cannington holds the Lebanese families, Willetton holds the Persian community, Ferndale holds the Iraqi and Syrian families, Nollamara holds the Turkish community. Lebanese Mahrajan in Perth every May at Whiteman Park pulls six thousand, Persian Norouz at Forrest Place every March pulls three thousand, Turkish Community Festival at Russell Square every August, Iraqi Community Festival at the Mirrabooka Multicommunity Services Centre every October. Lebanese food on William Street Northbridge and Bannister Road Canning Vale, Persian food in Willetton, Turkish food in Cannington. The Lebanese Australian Community Society of WA and Iranian Community Society of WA coordinate year-round events. EventLinqs is built for Perth Middle Eastern organisers running events that anchor a Levantine community on Australia's western edge.",
  },
  'middle-eastern/adelaide': {
    hero_subtitle: "Festival city, Levantine welcome.",
    editorial:
      "Adelaide's Middle Eastern community is mid-sized and warm. Salisbury and Para Hills hold the Lebanese families, Modbury holds the Persian community, Mawson Lakes holds the Iraqi and Syrian families, Croydon Park holds the Turkish community. Lebanese Mahrajan in Adelaide every May at Bonython Park pulls four thousand, Persian Norouz at Rymill Park every March pulls two thousand, Turkish Community Festival at the Adelaide Convention Centre every August, Iraqi Community Festival at the Salisbury Civic Centre every October. Lebanese food on Henley Beach Road and Prospect Road, Persian food in Modbury, Turkish food in Salisbury. The Lebanese Australian Community Society of SA and Iranian Community Society of SA coordinate year-round events. Adelaide Fringe each March always picks up at least one Middle Eastern music or comedy act. EventLinqs is built for Adelaide Middle Eastern organisers running events that anchor a Levantine community in the festival city.",
  },
  'middle-eastern/gold-coast': {
    hero_subtitle: "Coast life, Levantine warmth.",
    editorial:
      "The Gold Coast Middle Eastern community is mid-sized and lifestyle-led. Robina holds the Lebanese families, Helensvale holds the Persian community, Southport holds the Iraqi and Syrian families, Burleigh Heads holds the Turkish community. Lebanese Mahrajan every May at the Carrara Stadium function rooms pulls three thousand, Persian Norouz at Broadwater Parklands every March pulls two thousand, Turkish Community Festival at HOTA every August, Iraqi Community Festival at the Robina Community Centre every October. Lebanese food in Robina and Carrara, Persian food in Helensvale. The Lebanese Australian Community Society of the Gold Coast and Iranian Community Society of the Gold Coast coordinate year-round events. EventLinqs is built for Gold Coast Middle Eastern organisers running events that match coast lifestyle to Levantine warmth.",
  },
  'middle-eastern/canberra': {
    hero_subtitle: "Capital community, Levantine welcome.",
    editorial:
      "Canberra's Middle Eastern community is small and embassy-anchored. The Lebanese Embassy, Iranian Embassy, Iraqi Embassy and Turkish Embassy run year-round community events that feed into community calendars. Curtin and Fisher hold the Lebanese families, Kambah holds the Persian community, Tuggeranong holds the Iraqi and Syrian families, Belconnen holds the Turkish community. Lebanese Mahrajan in Canberra every May at Glebe Park pulls one thousand, Persian Norouz at the Canberra Theatre every March pulls eight hundred, Turkish Community Festival at the Embassy of Turkey every August, Iraqi Community Festival at the Tuggeranong Community Hub every October. The Lebanese Australian Community Society of the ACT and Iranian Community Society of the ACT coordinate the year-round calendar. EventLinqs is built for Canberra Middle Eastern organisers running events that thread Levantine warmth through the federal capital.",
  },
  'middle-eastern/hobart': {
    hero_subtitle: "Apple Isle, Levantine welcome.",
    editorial:
      "Hobart's Middle Eastern community is small but community rich. Glenorchy holds the Lebanese families, Sandy Bay holds the Persian community, Bridgewater holds the Iraqi and Syrian families. Lebanese Mahrajan every May at the Hobart Town Hall pulls four hundred, Persian Norouz at Salamanca Lawns every March pulls three hundred, Turkish Community Festival every August at Princes Wharf, Iraqi Community Festival every October at PW1 in Salamanca. Lebanese food in North Hobart, Persian food in Sandy Bay. The Tasmanian Lebanese Australian Society and Iranian Community Society of Tasmania coordinate the year-round calendar. The University of Tasmania Middle Eastern Studies programme runs community nights through every semester. The community is small enough that everyone shows up, big enough that the calendar stays steady. EventLinqs is built for Hobart Middle Eastern organisers running events that bring Levantine warmth to Australia's coldest capital.",
  },
  'middle-eastern/newcastle': {
    hero_subtitle: "Steel city, Levantine welcome.",
    editorial:
      "Newcastle's Middle Eastern community has grown through the University of Newcastle and the wider Hunter migration. Hamilton holds the Lebanese families, Mayfield holds the Persian community, Wallsend holds the Iraqi and Syrian families. Lebanese Mahrajan every May at Civic Park pulls two thousand, Persian Norouz at the Newcastle Town Hall every March pulls one thousand, Turkish Community Festival at the Wests City function rooms every August, Iraqi Community Festival at the Charlestown Memorial Hall every October. Lebanese food on Beaumont Street, Persian food on Hunter Street. The Hunter Region Lebanese Australian Society and Iranian Community Society of the Hunter coordinate the year-round calendar. The University of Newcastle Middle Eastern Studies programme runs community nights through every semester. EventLinqs is built for Newcastle Middle Eastern organisers running events that anchor a Levantine community in the steel river city.",
  },
  'middle-eastern/wollongong': {
    hero_subtitle: "Illawarra coast, Levantine warmth.",
    editorial:
      "Wollongong's Middle Eastern community has grown through the University of Wollongong and the wider Illawarra migration. Cringila holds the Lebanese families, Berkeley holds the Persian community, Warrawong holds the Iraqi and Syrian families. Lebanese Mahrajan every May at Stuart Park pulls one thousand five hundred, Persian Norouz at the IPAC every March pulls eight hundred, Turkish Community Festival at McCabe Park every August, Iraqi Community Festival at the Wollongong Town Hall every October. Lebanese food on Crown Street and Princes Highway, Persian food in Figtree. The Illawarra Lebanese Australian Society and Iranian Community Society of the Illawarra coordinate the year-round calendar. The University of Wollongong Middle Eastern Studies programme runs community nights through every semester. EventLinqs is built for Wollongong Middle Eastern organisers running events that thread Levantine welcome through the steel coast.",
  },
  'middle-eastern/geelong': {
    hero_subtitle: "Bay city, Levantine welcome.",
    editorial:
      "Geelong's Middle Eastern community has grown rapidly through professional migration. Norlane holds the Lebanese families, Highton holds the Persian community, Belmont holds the Iraqi and Syrian families. Lebanese Mahrajan every May at Eastern Park pulls one thousand, Persian Norouz at Steampacket Gardens every March pulls six hundred, Turkish Community Festival every August at Johnstone Park, Iraqi Community Festival every October at the Geelong Showgrounds. Lebanese food on Pakington Street, Persian food in Highton. The Geelong Lebanese Australian Society and Iranian Community Society of Geelong coordinate the year-round calendar. The Deakin University Middle Eastern Studies programme runs community nights through every semester. EventLinqs is built for Geelong Middle Eastern organisers running events that bring Levantine welcome to the second city of Victoria.",
  },
  'middle-eastern/sunshine-coast': {
    hero_subtitle: "Hinterland warm, Levantine sun.",
    editorial:
      "The Sunshine Coast Middle Eastern community is small but growing. Buderim holds the Lebanese families, Maroochydore holds the Persian community, Caloundra holds the Iraqi and Syrian families. Lebanese Mahrajan every May at Cotton Tree Park pulls eight hundred, Persian Norouz at the Lake Kawana Community Centre every March pulls four hundred, Turkish Community Festival every August at the Maroochy RSL function rooms, Iraqi Community Festival every October at the Caloundra Community Centre. Lebanese food on Mooloolaba Esplanade, Persian food in Buderim. The Sunshine Coast Lebanese Australian Society and Iranian Community Society of the Sunshine Coast coordinate the year-round calendar. The University of the Sunshine Coast Middle Eastern Studies programme runs community nights through every semester. EventLinqs is built for Sunshine Coast Middle Eastern organisers running events that match coast lifestyle to Levantine warmth.",
  },
  'middle-eastern/cairns': {
    hero_subtitle: "Tropical north, Levantine warmth.",
    editorial:
      "Cairns has a small but warm Middle Eastern community. Manunda holds the Lebanese families, Edmonton holds the Persian community, Westcourt holds the Iraqi and Syrian families. Lebanese Mahrajan every May at Munro Martin Parklands pulls five hundred, Persian Norouz at the Cairns Convention Centre every March pulls three hundred, Turkish Community Festival every August at the Cairns Showgrounds, Iraqi Community Festival every October at the Brothers Leagues Club. Lebanese food on Sheridan Street, Persian food in Earlville. The Far North Queensland Lebanese Australian Society and Iranian Community Society of Cairns coordinate the year-round calendar. The James Cook University Middle Eastern Studies programme runs community nights through every semester. EventLinqs is built for Cairns Middle Eastern organisers running events that bring Levantine warmth into the tropics.",
  },
  'middle-eastern/darwin': {
    hero_subtitle: "Top End, Levantine warmth.",
    editorial:
      "Darwin's Middle Eastern community is small and dry-season-anchored. Karama holds the Lebanese families, Anula holds the Persian community, Casuarina holds the Iraqi and Syrian families. Lebanese Mahrajan every August at Bicentennial Park pulls six hundred, Persian Norouz every March at the Darwin Convention Centre pulls four hundred, Turkish Community Festival every August at Mindil Beach Sunset Markets, Iraqi Community Festival every October at the Marrara Sporting Complex. Lebanese food on Mitchell Street, Persian food on Knuckey Street. The Northern Territory Lebanese Australian Society and Iranian Community Society of the NT coordinate the year-round calendar. The Charles Darwin University Middle Eastern Studies programme runs community nights through every semester. EventLinqs is built for Darwin Middle Eastern organisers running events that bring Levantine warmth to Australia's most tropical capital.",
  },
  'middle-eastern/townsville': {
    hero_subtitle: "Tropical north, Levantine welcome.",
    editorial:
      "Townsville's Middle Eastern community is small and family-led. Annandale holds the Lebanese families, Kelso holds the Persian community, Kirwan holds the Iraqi and Syrian families. Lebanese Mahrajan every May at Riverway pulls six hundred, Persian Norouz at the Civic Theatre every March pulls four hundred, Turkish Community Festival every August at the Townsville Showgrounds, Iraqi Community Festival every October at the Brothers Leagues Club. Lebanese food on Flinders Street, Persian food in Aitkenvale. The North Queensland Lebanese Australian Society and Iranian Community Society of Townsville coordinate the year-round calendar. The James Cook University Middle Eastern Studies programme runs community nights through every semester. EventLinqs is built for Townsville Middle Eastern organisers running events that anchor a Levantine community in tropical north Queensland.",
  },
  'middle-eastern/london': {
    hero_subtitle: "Edgware Road and beyond.",
    editorial:
      "London's Middle Eastern community is the most diverse in Europe. Edgware Road is Little Beirut, Kensington High Street holds the wealthy Persian families, Wembley holds the Iraqi and Syrian community, Stoke Newington and Dalston hold the Turkish families. Lebanese Mahrajan every July at Royal Festival Hall pulls fifteen thousand, Norouz Festival at Trafalgar Square every March pulls one hundred thousand for the largest Persian celebration outside Iran, Turkish Festival at Trafalgar Square every August, Iraqi Community Festival at Olympia London every October. Lebanese food on Edgware Road, Persian food in Kensington, Turkish food on Green Lanes. The Iran Heritage Foundation and Lebanese British Community Society coordinate the year-round calendar. EventLinqs is built for London Middle Eastern organisers running events that anchor the most diverse Levantine community in Europe.",
  },
  ...
  'european/sydney': {
    ...
    editorial:
      "Sydney's European community runs through the inner west and the south. Ashfield holds the Polish families, Bondi Junction holds the German community, Vaucluse holds the French expats, Bossley Park holds the Croatian and Serbian community, Cabramatta holds the Russian and Ukrainian families. Polish Festival at Marrickville every September pulls eight thousand, German Oktoberfest at the Concourse Chatswood every October pulls fifteen thousand, French Bastille Day at Circular Quay every July pulls ten thousand, Croatian Community Festival at Bossley Park every May, Russian Community Festival at Strathfield every October. The Polish Club in Ashfield, the German Club in Concord, the Alliance Francaise in Bondi all coordinate year-round events. European food on Bondi Junction, Concord Road, Liverpool Road. EventLinqs is built for Sydney European organisers running events that have shaped the city's most established European-Australian communities.",
  },
  'european/melbourne': {
    hero_subtitle: "Old World, Melbourne stage.",
    editorial:
      "Melbourne's European community runs through the north and east. Springvale holds the Polish families, Doncaster holds the German community, Toorak holds the French expats, Sunshine West holds the Croatian and Serbian families, Carlton holds the Russian community. Polish Festival at Federation Square every September pulls ten thousand, German Oktoberfest at the Royal Botanic Gardens every October pulls twenty thousand, French Bastille Day at Federation Square every July pulls eight thousand, Croatian Community Festival at the Royal Park every May, Russian Community Festival at the Russian Hall in Caulfield every October. The Polish Club in Footscray, the German Club in Tullamarine, the Alliance Francaise in St Kilda all coordinate year-round events. European food on Sydney Road, Toorak Road, Bridge Road. EventLinqs is built for Melbourne European organisers running events that thread Old World celebration through Australia's most European-feeling capital.",
  },
  'european/brisbane': {
    hero_subtitle: "Sunshine state, Old World heart.",
    editorial:
      "Brisbane's European community is mid-sized and family-led. Springwood holds the Polish families, Mount Gravatt holds the German community, New Farm holds the French expats, Inala holds the Croatian and Serbian families, Sunnybank holds the Russian community. Polish Festival at South Bank every September pulls four thousand, German Oktoberfest at the Brisbane Showgrounds every October pulls twelve thousand, French Bastille Day at Roma Street Parkland every July pulls five thousand, Croatian Community Festival at the Inala Civic Centre every May, Russian Community Festival at the South Brisbane Town Hall every October. The Polish Club Brisbane in Milton, the German Club Brisbane in Macgregor, the Alliance Francaise Brisbane in Toowong all coordinate year-round events. European food in New Farm, Bulimba and Newstead. EventLinqs is built for Brisbane European organisers running events that anchor an Old World community in Queensland's biggest city.",
  },
  'european/perth': {
    hero_subtitle: "Indian Ocean to the Old continent.",
    editorial:
      "Perth's European community is established and proudly multicommunity. Maylands holds the Polish families, Subiaco holds the German community, Cottesloe holds the French expats, Spearwood holds the Croatian and Serbian community, Rivervale holds the Russian families. Polish Festival at Russell Square every September pulls four thousand, German Oktoberfest at the Perth Convention Centre every October pulls eight thousand, French Bastille Day at Forrest Place every July pulls four thousand, Croatian Community Festival at the Spearwood Civic Centre every May, Russian Community Festival at the Polish Hall in Subiaco every October. The Polish Australian Club in Maylands, the German Club Perth in Maylands, the Alliance Francaise Perth in Mount Lawley all coordinate year-round events. European food on Beaufort Street and South Terrace Fremantle. EventLinqs is built for Perth European organisers running events that anchor Old World celebration on Australia's western edge.",
  },
  'european/adelaide': {
    hero_subtitle: "Festival city, Old continent welcome.",
    editorial:
      "Adelaide's European community is one of the most established in Australia. Hahndorf is the heart of the South Australian German community (the oldest German settlement in the country), Royal Park holds the Polish families, Norwood holds the French expats, Salisbury holds the Croatian and Serbian families, Pooraka holds the Russian community. Schutzenfest in Hahndorf every January pulls thirty thousand for the largest German community festival in Australia, Polish Community Festival at Bonython Park every September, French Bastille Day at the Adelaide Festival Centre every July, Croatian Community Festival at the Salisbury Civic Centre every May, Russian Community Festival at the Adelaide Showgrounds every October. The Polish Club Adelaide in Wayville, the German Club Adelaide in Flinders Park, the Alliance Francaise Adelaide in Adelaide CBD all coordinate year-round events. EventLinqs is built for Adelaide European organisers running events that have shaped South Australia's most distinctive Old World communities.",
  },
  'european/gold-coast': {
    hero_subtitle: "Coast life, Old continent celebration.",
    editorial:
      "The Gold Coast European community is mid-sized and lifestyle-led. Robina holds the Polish families, Helensvale holds the German community, Burleigh Heads holds the French expats, Carrara holds the Croatian and Serbian families, Surfers Paradise holds the Russian tourist hospitality crowd. Polish Community Festival at Broadwater Parklands every September pulls two thousand, German Oktoberfest at HOTA every October pulls eight thousand, French Bastille Day at Burleigh Heads every July pulls four thousand, Croatian Community Festival at the Carrara Stadium function rooms every May, Russian Community Festival at Surfers Paradise every October. The Gold Coast Polish Community Society, German Australian Society of the Gold Coast, and Alliance Francaise Gold Coast all coordinate year-round events. EventLinqs is built for Gold Coast European organisers running events that match coast lifestyle to Old World celebration.",
  },
  'european/canberra': {
    hero_subtitle: "Capital community, Old continent stage.",
    editorial:
      "Canberra's European community is embassy-anchored and community rich. The Polish, German, French, Croatian, Russian and Italian embassies all run year-round community events that feed into community calendars. Curtin and Yarralumla hold the European diplomatic community, Belconnen holds the Polish and German families, O'Connor holds the French expats, Tuggeranong holds the Croatian and Serbian families. Polish Community Festival at the Polish Embassy every September pulls two thousand, German Oktoberfest at the Embassy of Germany every October pulls four thousand, French Bastille Day at the Embassy of France every July pulls three thousand, Croatian Community Festival at the Croatian Embassy every May, Russian Community Festival at the National Multicommunity Festival every February. The Polish Australian Community Society of the ACT, German Australian Society of Canberra, and Alliance Francaise Canberra all coordinate year-round events. EventLinqs is built for Canberra European organisers running events that thread Old World celebration through the federal capital.",
  },
  'european/hobart': {
    hero_subtitle: "Apple Isle, Old continent welcome.",
    editorial:
      "Hobart's European community is small but community rich. North Hobart holds the Polish families, Sandy Bay holds the German community, Battery Point holds the French expats, Glenorchy holds the Croatian and Serbian families. Polish Community Festival at the Polish Hall in Hobart every September pulls eight hundred, German Oktoberfest at the German Club in Glenorchy every October pulls one thousand five hundred, French Bastille Day at Salamanca Lawns every July pulls eight hundred, Croatian Community Festival at the Croatian Hall in Glenorchy every May. The Polish Australian Community Society of Tasmania, German Club Hobart, and Alliance Francaise Hobart all coordinate the year-round calendar. The University of Tasmania European Studies programme runs community nights through every semester. EventLinqs is built for Hobart European organisers running events that bring Old World celebration to Australia's southernmost capital.",
  },
  'european/newcastle': {
    hero_subtitle: "Steel city, Old continent welcome.",
    editorial:
      "Newcastle's European community is established and growing. Hamilton holds the Polish families, Mayfield holds the German community, Cooks Hill holds the French expats, Wallsend holds the Croatian and Serbian families, Charlestown holds the Russian community. Polish Community Festival at Civic Park every September pulls one thousand five hundred, German Oktoberfest at the Newcastle Showgrounds every October pulls four thousand, French Bastille Day at the Newcastle Town Hall every July pulls two thousand, Croatian Community Festival at the Wallsend Town Hall every May, Russian Community Festival at the Newcastle Multicommunity Centre every October. The Polish Club Newcastle, German Australian Society of the Hunter, and Alliance Francaise Newcastle all coordinate year-round events. The University of Newcastle European Studies programme runs community nights through every semester. EventLinqs is built for Newcastle European organisers running events that anchor Old World celebration in the steel river city.",
  },
  'european/wollongong': {
    hero_subtitle: "Illawarra coast, Old continent stage.",
    editorial:
      "Wollongong's European community is one of the most established in regional NSW. Cringila and Port Kembla hold the Polish, Croatian and Serbian families (the original 1950s migrant heart of the steel industry), Berkeley holds the German community, Figtree holds the French expats. Polish Community Festival at Stuart Park every September pulls two thousand, German Oktoberfest at the German Club Wollongong every October pulls three thousand, French Bastille Day at the IPAC every July pulls one thousand five hundred, Croatian Community Festival at the Cringila Croatian Hall every May pulls four thousand, Russian Community Festival at the Wollongong Town Hall every October. The Polish Club Wollongong, German Club Wollongong, and Alliance Francaise Illawarra all coordinate year-round events. The University of Wollongong European Studies programme runs community nights through every semester. EventLinqs is built for Wollongong European organisers running events that thread Old World heritage through the steel coast.",
  },
  'european/geelong': {
    hero_subtitle: "Bay city, Old continent roots.",
    editorial:
      "Geelong's European community runs deep. Polish, Croatian, Italian and German families landed in Norlane and Corio through the post-war migration. Now the second and third generations keep the community alive. Polish Community Festival at Johnstone Park every September pulls one thousand five hundred, German Oktoberfest at the Geelong Showgrounds every October pulls three thousand, French Bastille Day at Steampacket Gardens every July pulls one thousand, Croatian Community Festival at the Croatian Club Geelong every May, Russian Community Festival at the Geelong Multicommunity Centre every October. The Polish Club Geelong in Corio, German Club Geelong in North Geelong, and Alliance Francaise Geelong all coordinate year-round events. The Deakin University European Studies programme runs community nights through every semester. EventLinqs is built for Geelong European organisers running events that anchor Old World heritage in the bay city.",
  },
  'european/sunshine-coast': {
    hero_subtitle: "Hinterland warm, Old continent welcome.",
    editorial:
      "The Sunshine Coast European community is small but growing. Buderim holds the Polish and German families, Mooloolaba holds the French expats, Caloundra holds the Croatian and Serbian community. Polish Community Festival at Cotton Tree Park every September pulls eight hundred, German Oktoberfest at the Lake Kawana Community Centre every October pulls two thousand, French Bastille Day at Mooloolaba Esplanade every July pulls one thousand, Croatian Community Festival at the Maroochy RSL function rooms every May, Russian Community Festival at the Sunshine Coast Convention Centre every October. The Sunshine Coast Polish Community Society, German Australian Society of the Sunshine Coast, and Alliance Francaise Sunshine Coast all coordinate year-round events. The University of the Sunshine Coast European Studies programme runs community nights through every semester. EventLinqs is built for Sunshine Coast European organisers running events that match coast lifestyle to Old World celebration.",
  },
  'european/cairns': {
    hero_subtitle: "Tropical north, Old continent welcome.",
    editorial:
      "Cairns has a small European community. Manunda holds the Polish and German families, Edge Hill holds the French expats, Edmonton holds the Croatian and Serbian community. Polish Community Festival at Munro Martin Parklands every September pulls four hundred, German Oktoberfest at the Cairns Showgrounds every October pulls one thousand five hundred, French Bastille Day at the Cairns Esplanade every July pulls six hundred, Croatian Community Festival at the Cairns Convention Centre every May, Russian Community Festival at the Brothers Leagues Club every October. The Far North Queensland Polish Community Society, German Australian Society of Cairns, and Alliance Francaise Cairns all coordinate year-round events. The James Cook University European Studies programme runs community nights through every semester. EventLinqs is built for Cairns European organisers running events that bring Old World celebration into the tropics.",
  },
  'european/darwin': {
    hero_subtitle: "Top End energy, Old continent welcome.",
    editorial:
      "Darwin's European community is small and dry-season-anchored. Karama holds the Polish and German families, Anula holds the French expats, Casuarina holds the Croatian and Serbian community. Polish Community Festival at Bicentennial Park every August pulls four hundred, German Oktoberfest at the Darwin Convention Centre every October pulls one thousand, French Bastille Day at Mindil Beach Sunset Markets every July pulls eight hundred, Croatian Community Festival at the Darwin Multicommunity Centre every May, Russian Community Festival at the Marrara Sporting Complex every October. The Northern Territory Polish Community Society, German Australian Society of the NT, and Alliance Francaise Darwin all coordinate year-round events. The Charles Darwin University European Studies programme runs community nights through every semester. EventLinqs is built for Darwin European organisers running events that bring Old World warmth to Australia's most tropical capital.",
  },
  'european/townsville': {
    hero_subtitle: "Tropical north, Old continent welcome.",
    editorial:
      "Townsville's European community is small and family-led. Annandale holds the Polish and German families, Kelso holds the French expats, Aitkenvale holds the Croatian and Serbian community. Polish Community Festival at Riverway every September pulls four hundred, German Oktoberfest at the Townsville Showgrounds every October pulls one thousand, French Bastille Day at the Strand every July pulls six hundred, Croatian Community Festival at the Civic Theatre every May, Russian Community Festival at the Brothers Leagues Club every October. The North Queensland Polish Community Society, German Australian Society of Townsville, and Alliance Francaise Townsville all coordinate year-round events. The James Cook University European Studies programme runs community nights through every semester. EventLinqs is built for Townsville European organisers running events that anchor Old World celebration in tropical north Queensland.",
  },
  'european/london': {
    hero_subtitle: "The continent's capital outside the EU.",
    editorial:
      "London is Europe's largest non-EU capital. Hammersmith and Acton hold the Polish community (the largest outside Poland), Soho's German Club anchors the German families, South Kensington holds the French families (the largest French community outside France), Earl's Court holds the New Zealand-British and Australian-British community alongside Eastern Europeans, Stamford Hill holds the Russian Jewish community. Polish Community Festival at Trafalgar Square every September pulls fifty thousand, German Christmas Markets at Hyde Park every December pull a million, French Bastille Day at Trafalgar Square every July pulls thirty thousand, Croatian Community Festival at Imperial College every May, Russian Community Festival at the Russian Embassy every October. The Polish Community Institute, Goethe-Institut London, Institut Francais all coordinate year-round events. EventLinqs is built for London European organisers running events that anchor the most diverse continental community in any non-European capital.",
  },
  'european/new-york': {
    hero_subtitle: "Five boroughs, Old continent stage.",
    editorial:
      "New York's European community runs through Brooklyn and Queens. Greenpoint Brooklyn is Little Poland (the largest Polish community in America), Yorkville Manhattan was the historic German neighbourhood, Bay Ridge holds the Norwegian and Swedish community, Astoria holds the Greek and Italian families. Polish Festival at Greenpoint every September pulls one hundred thousand for the largest Polish-American festival in the world, German-American Steuben Parade up Fifth Avenue every September, French Bastille Day at Smith Street Brooklyn every July, Russian Community Festival at Coney Island every June pulls fifty thousand, Czech Community Festival at Bohemian Hall in Astoria every May. Polish food on Manhattan Avenue, German food on East 86th Street, French food in West Village. The Kosciuszko Foundation and Goethe-Institut New York coordinate year-round events. EventLinqs is built for New York European organisers running events that anchor America's most established Old World community.",
  },
  'european/toronto': {
    hero_subtitle: "Lakeside, Old continent welcome.",
    editorial:
      "Toronto's European community runs through Roncesvalles and the west end. Roncesvalles is Little Poland (the largest Polish community in Canada), Yonge-Eglinton holds the German community, Mississauga holds the French Canadian and Ukrainian families, Bloor West holds the Polish suburban families. Polish Festival on Roncesvalles every September pulls four hundred thousand for the largest Polish-Canadian festival, German-Canadian Festival at the Roy Thomson Hall every October, French Community Festival at Centerpoint every July, Ukrainian Festival at the West End every September pulls eight hundred thousand. Polish food on Roncesvalles Avenue, German food in Kensington Market, French food in Yorkville. The Polish Community Centre Toronto, Goethe-Institut Toronto, and Alliance Francaise Toronto coordinate year-round events. EventLinqs is built for Toronto European organisers running events that anchor Canada's biggest Old World community.",
  },
  'european/berlin': {
  ...
  'european/paris': {
    ...
    editorial:
      "Paris is the community capital of continental Europe. Le Marais holds the Jewish and LGBTQ+ heart, Belleville holds the multicommunity French community, Saint-Germain-des-Prés holds the literary and arts heart, Montmartre holds the historic French cabaret scene. Bastille Day every 14 July fills the Champs-Élysées with one million, Fête de la Musique every 21 June turns every street into a stage, Paris Plages takes over the Seine each August, Nuit Blanche every October fills the city with all-night community events. The Paris Festival of European Communities every September. Le Bal des Pompiers (Firefighters Ball) every Bastille Day. Olympia, Bataclan, La Cigale anchor the live music scene. Paris is the city that defines European elegance globally and exports it to every continent. EventLinqs is built for Paris European organisers running the events that the rest of the world watches and copies.",
  },
 ...
 * The fallback exists for forward-compatibility: if a new community city
...
function fallbackEditorial(community: CommunityContent, cityName: string, cityRecord: CityContent | null): string {
  const subCommunityLabels = community.subCommunities.slice(0, 4).map(s => s.label)
  const subCommunitySentence = subCommunityLabels.length > 0
    ? `${joinList(subCommunityLabels)} are all on across ${cityName} when the calendar fills up.`
    : `Every ${community.displayName} sound is on across ${cityName} when the calendar fills up.`
  const stateLine = cityRecord?.state
    ? `${cityName}, ${cityRecord.state}, has a ${community.displayName.toLowerCase()} community that books every kind of venue, from community halls to live-music venues to outdoor festival sites.`
    : `${cityName} has a ${community.displayName.toLowerCase()} community that books every kind of venue.`
  return `${stateLine} ${subCommunitySentence} EventLinqs is built for ${cityName} ${community.displayName.toLowerCase()} organisers who want transparent fees, WhatsApp-first sharing, and squad bookings so the whole crew comes together. ${community.tagline}`
}
