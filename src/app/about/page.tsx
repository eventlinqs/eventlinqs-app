...
const VALUES = [
  ...
  },
  {
    ...
    body:
      'Twenty-one heritages, led by Aboriginal and Torres Strait Islander peoples, alongside five faith communities and every event type. We learn each community before we promise discovery.',
  },
  {
...
const PRINCIPLES = [
  ...
  },
  {
    ...
    body:
      'Discovery is organised across three honest dimensions: 21 heritages led by First Nations Australians, five faith communities, and event type. Heritage, faith and format are kept distinct, never collapsed into one generic bucket.',
  },
  {
