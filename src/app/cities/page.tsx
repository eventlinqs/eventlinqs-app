...
export const metadata: Metadata = {
  ...
  description: '20 cities across Australia, from Sydney and Melbourne to Hobart and Darwin. Find community events near you.',
  alternates: { canonical: '/cities' },
  openGraph: {
    title: 'Browse by City | EventLinqs',
    description: 'Find community events in 20 cities across Australia.',
    url: '/cities',
    type: 'website',
  },
  twitter: {
    ...
    <div className="flex min-h-screen flex-col bg-canvas">
      ...
      <main className="flex-1">
        <PhotographicCultureHero
          ...
          subtitle="Find community events near you."
          imageSrc={heroImage}
        />
        ...
        <Section
          ...
          subheading="Twelve regional centres where community events deserve a stage as much as the capitals."
          tier={2}
        >
