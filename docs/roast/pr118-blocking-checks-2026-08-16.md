...
| 4 | Report distinctly and pass, naming the pending migrations | MET | Drill `pending` raw output names `supabase/migrations/20260815000001_external_ticketing.sql` and lists all 12 deltas it explains. Exit 0 |
