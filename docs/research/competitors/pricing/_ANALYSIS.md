...
- ticketmaster-consumer.md - ticketmaster.com.au homepage + Guns N' Roses artist page (mobile 390x844). Evidence: no price/fee on any discovery surface, ad slots, browser-not-supported banner, OneTrust consent wall, reCAPTCHA, mega-brand only, capital-city only.  <!-- UNSOURCED: Law 7, third-party spec with no primary source cited -->
- dice-consumer.md - dice.fm homepage + an event page (mobile 390x844). Evidence: "See the full price upfront, with no surprises at checkout" and "From $21.53 The price you'll pay. No surprises later." (DICE explicitly counter-positions on Ticketmaster's hidden fees); app-download funnel; US-geo/USD even on an AU request; club/gig vertical only.  <!-- UNSOURCED: Law 7, third-party spec with no primary source cited -->
